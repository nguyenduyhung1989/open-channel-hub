...
ADRs record decisions whose rationale people will still need to understand six months later. The `accepted` status means a decision is in effect; it does not mean a feature is complete.
