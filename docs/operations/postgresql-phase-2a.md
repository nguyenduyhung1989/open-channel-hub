...
and Phase 4i adds candidate Telegram private-reply evidence; neither is verified
source evidence or a provider-dispatch claim.
...
Phase 4h–4i local and GitHub verification remains pending.
